...
export class Session2 extends HeyApiClient {
     ...
     *
     * Retrieve the persisted secretary compaction status for a session.
     */
    public secretaryStatus<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).get<SessionSecretaryStatusResponses, unknown, ThrowOnError>({
