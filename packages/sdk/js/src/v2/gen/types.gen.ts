...
export type GlobalEvent = {
  ...
  payload:
    ...
    | SyncEventSessionNextSecretaryStarted
    | SyncEventSessionNextSecretaryRetrying
    | SyncEventSessionNextSecretarySucceeded
    | SyncEventSessionNextSecretaryFailed
    | SyncEventSessionNextSecretaryCompactWaiting
    | SyncEventSessionNextSecretaryCompactDegraded
    | SyncEventSessionNextSecretaryCompactStarted
    | SyncEventSessionNextSecretaryCompactSwitched
}
...
export type SyncEventSessionNextSecretaryStarted = {
  type: "sync"
  name: "session.next.secretary.started.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryRetrying = {
  type: "sync"
  name: "session.next.secretary.retrying.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretarySucceeded = {
  type: "sync"
  name: "session.next.secretary.succeeded.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryFailed = {
  type: "sync"
  name: "session.next.secretary.failed.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryCompactWaiting = {
  type: "sync"
  name: "session.next.secretary.compact.waiting.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryCompactDegraded = {
  type: "sync"
  name: "session.next.secretary.compact.degraded.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryCompactStarted = {
  type: "sync"
  name: "session.next.secretary.compact.started.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type SyncEventSessionNextSecretaryCompactSwitched = {
  type: "sync"
  name: "session.next.secretary.compact.switched.1"
  id: string
  seq: number
  aggregateID: "sessionID"
  data: {
...
export type EventSessionNextSecretaryStarted = {
  id: string
...
export type EventSessionNextSecretaryRetrying = {
  id: string
...
export type EventSessionNextSecretarySucceeded = {
  id: string
...
export type EventSessionNextSecretaryFailed = {
  id: string
...
export type EventSessionNextSecretaryCompactWaiting = {
  id: string
...
export type EventSessionNextSecretaryCompactDegraded = {
  id: string
...
export type EventSessionNextSecretaryCompactStarted = {
  id: string
...
export type EventSessionNextSecretaryCompactSwitched = {
  id: string
